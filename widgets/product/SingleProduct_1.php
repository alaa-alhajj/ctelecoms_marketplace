    ...
    <div class="col-sm-6">
        ...
        <div class="AddedToCart <?= $show_add ?>">
            ...
            <div class='row row-nomargin product-price loadImgAdd rel-div'>
                ...
                <div class="col-sm-6 cart-button"><a href='javascript:;' class="addToCart" data-id="<?= $product_id ?>" data-single='single'><i class="fa fa-cart-plus" aria-hidden="true"></i><span> Add to Cart</span></a></div>
        ...
        <div class="row row-margin RemovedToCompare <?= $removeFromCompare ?>">
            <div class="col-sm-12">
                <a href='javascript:;' class="removeFromCompare Compare-btn" data-id="<?= $product_id ?>" data-single='single'><i class="fa fa-refresh" aria-hidden="true"></i><span> Remove From Compare</span></a>
            </div>
        </div>
