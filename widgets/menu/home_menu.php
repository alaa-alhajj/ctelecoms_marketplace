<?php
$query = $this->fpdo->from('menus')->where("  p_id=0 and active='1' and company_id='1' ")->orderBy("item_order ASC")->fetchAll();
...
if($menu_numrows){
	...
	foreach ($query as $row){
		...
		$class1='';
		$query2 = $this->fpdo->from('menus')->where("  p_id='$p_id' and active='1' and company_id='1' ")->orderBy("item_order ASC")->fetchAll();
...
<div class="textbox homepage">
    <nav class="navbar navbar-default nav-rustom">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav color-nav-rustom">
                    <?=$res_menu?>
                </ul>
            </div>
        </div>
