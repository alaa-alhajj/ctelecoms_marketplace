...
$listTable->_columns(array('title','discount_percentage','start_date','end_date'));
...
$listTable->_dublicate($db_table, 'id', $pageUpdate, $dublicated_cols, $_REQUEST['cmsMID'], 'true');
