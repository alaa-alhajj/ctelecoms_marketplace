...
if($resArr['delivered_num'] != 0){
    $deliveredPer=(100*$resArr['delivered_num'])/$resArr['delivered_num'];
    $recipientPer=(100*$resArr['recipient_num'])/$resArr['delivered_num'];
    $openedPer=(100*$resArr['opened_num'])/$resArr['delivered_num'];
}
