       ...
       <?php            
            if(isset($_REQUEST) && $_REQUEST['action']=='Delete')
             {  
                ...
                $utils->redirect($trashPage);
             }
             
           //get unread comp ids  
           $arr=$complaintsObj->getMComplaints_ids('trash',$db_table,$db_cms_complaints_departments,$user_id);  
           $TrashComp_ids=$arr[0];
       ?> 
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="mailbox-controls">
                    ...
                    <button class="btn btn-default btn-sm" onClick="window.location='<?=$trashPage?>'"><i class="fa fa-refresh"></i></button>
                    <div class="pull-right">
                      <?php
                        $pg=$complaintsObj->Create_pagination($TrashComp_ids,$LPP,$pn,$start,$limit);
                         echo $pg['pg_format'];
                      ?>  
                      <div class="btn-group">
                      ...
                      <tbody>
                          <?php    
                                    ...
                                    if(isset($_REQUEST['title']) && $_REQUEST['title']!=""){
                                     ...
                                     if (count($TrashComp_ids)>0){
                                            $conditions = " $filter id in (".implode(",",$TrashComp_ids).") order by id desc $limit ";
                                            $comps=$complaintsObj->showComplaints('trash',$db_table,$db_table_replies,$conditions);
                                            echo $comps;
                                     }
                                ?> 
