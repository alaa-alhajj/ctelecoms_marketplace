...
include 'config.php';?>
       ...
       <?php  
           ...
           //get messags ids from db and set number unread msgs
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="mailbox-controls">
                    ...
                    <div class="pull-right">
                      <?php
                        $pg=$mailbox->Create_pagination($msg_ids,$LPP,$pn,$start,$limit);
                         echo $pg['pg_format'];
                      ?>  
                      <div class="btn-group">
                    ...
                    <table class="table table-hover table-striped">
                      <tbody>
                          <?php    
                                    ...
                                    //echo $conditions;
                                    //get inbox messages
                                   $msgs=$mailbox->getMsgList('inbox',$db_table,$db_table_directions,$db_table_trash,$db_cms_users,$user_id,$filter,$limit); 
                                   echo $msgs;
                                ?> 
