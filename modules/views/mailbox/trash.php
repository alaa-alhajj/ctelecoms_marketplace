              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                    ...
                    <div class="pull-right">
                      <?php
                        $pg=$mailbox->Create_pagination($TrashMsg_ids,$LPP,$pn,$start,$limit);
                        echo $pg['pg_format'];
                      ?>  
                      <div class="btn-group">
                    ...
                    <table class="table table-hover table-striped">
                      <tbody>
                          <?php  
                                ...
                                $msgs=$mailbox->getMsgList('trash',$db_table,$db_table_directions,$db_table_trash,$db_cms_users,$user_id,$filter,$limit); 
                                echo $msgs;
                            ?> 
                      </tbody>
                    </table><!-- /.table -->
