...
$Congrats="<div class='col-sm-12'><h1 style='margin-top:130px;margin-bottom:60px;text-align:center'>Congratulations pricing setting has been entered successfully</h1></div>"
        .'<div class="col-sm-12" style="margin-bottom:130px;text-align:center">'
        . '   <a href="'.$pageInsertPricingDuration.'" class="btn btn-back " >Go to Dynamic Pricing Setting</a>&nbsp;'
