...
$config = array(
	...
	*/
	...
	'relative_path_from_current_pos'          => false,//array( 'cash/', 'cash/' ), //relative path of the image folder from the current position on upload folder
