...
if(checkGallogin()){  
	$img_arr = array("pdf","doc","docx","xls","xlsx");	
	$ret='';
	$ph=$_POST['attachs'];
	$photos=explode(',',$ph);
	$root='../../../uploads/attach/';
			...
			if ($file != "." && $file != "..") {
				...
				if(in_array($Ex,$img_arr)){
					if(!is_dir($root.$file)){
						...
						$img_name=lookupField('subjects_attach','attach','name',$file,"name!=''");
						if($img_name=='0')$img_name=$file;
                        ...
                        <div class="fl">										
                            ...
                            <div class="l_attach_title"><a href="../../uploads/attach/<?=$file?>" target="_blank">
							<?=$img_name?></a></div>
						</div><? 
					}
					$i++;			
