...
function lz_chat_update_room_member_list()
{
    ...
    if(lz_chat_data.MembersPrevious.length >= 2 || lz_chat_data.DynamicGroup != '')
    {
...
{	
	...
	if(_type == 0)
		...
		text = lz_chat_data.Language.ClientIntLeft + " <a href=\"javascript:parent.lz_chat_goto_message(true,false);\">" + lz_chat_data.Language.LanguageLeaveMessageShort + "</a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 4)
		text = lz_chat_data.Language.ClientIntDeclined + " <a href=\"javascript:parent.lz_chat_goto_message(true,false);\">" + lz_chat_data.Language.LanguageLeaveMessageShort + "</a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 5)
		text = lz_chat_data.Language.ClientStillWaitingInt + " <a href=\"javascript:parent.lz_chat_goto_message(true,false);\">" + lz_chat_data.Language.LanguageLeaveMessageShort + "</a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 6)
		text = lz_chat_data.Language.ClientIntIsConnected;
	else if(_type == 8)
		text = lz_chat_data.Language.ClientNoInternUsers + " <a href=\"javascript:parent.lz_chat_goto_message(true,false);\">" + lz_chat_data.Language.LanguageLeaveMessageShort + "</a>. " + lz_chat_data.Language.ClientThankYou;
	else if(_type == 9)
