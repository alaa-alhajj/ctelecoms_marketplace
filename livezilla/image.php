...
else if(!empty($_GET["tl"]) && !empty($_GET["srv"]))
{
	...
	if(!empty($html))
	    exit("var nc = document.createElement('div');nc.style.padding=0;nc.style.margin=0;nc.innerHTML=\"".$html."\";var tlscr = document.getElementById('lz_textlink');tlscr.parentNode.insertBefore(nc, tlscr);");
}
