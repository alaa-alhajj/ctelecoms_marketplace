(function($) {
    ...
    $.fn.cslide = function() {
        ...
        this.each(function() {
            ...
            // set slide width
            $(slidesContainerId+" .cslide-slide").css({
                width : slideWidth
            });
            ...
            $(slidesContainerId+" .cslide-next").click(function(){
                ...
                if(i < slideCounter-1){
                    //do effect on content
                    $(slidesContainerId+" .cslide-slide  .slider_content2").css('display','none');
                    setTimeout(function(){
                       $(slidesContainerId+" .cslide-slide  .slider_content2").show('slide',{direction : 'down'},900);
                    },500);
                }
            });
